    ...
    },
    {
        ...
        body: `
            ...
            <ul>
                ...
                <li><b>Est. APY</b> — the chain's nominal maximum APY (${MAX_APY_BASE}%) adjusted for the validator's <em>current</em> commission. It is a projection from today's commission, not a measured return, and it changes the moment the validator changes commission.</li>
            </ul>
